...
enum obj_global_error_code {
    ...
    OBJ_CODE_DB_ALREADY_EXISTS = 30002,
    OBJ_CODE_DB_COLLECTION_WRONG_FORMAT = 30003,
    OBJ_CODE_DB_COLLECTION_NOT_EXISTS = 30004,
    OBJ_CODE_DB_COLLECTION_ALREADY_EXISTS = 30005,
    OBJ_CODE_DB_COLLECTION_TYPE_DEFINE_INVALID = 30006,
    OBJ_CODE_DB_INSERT_OBJECT_TYPE_ERROR = 30007,
    /* query error code */
    ...
    OBJ_CODE_INDEX_NOT_FOUND = 60004,
    /* command */
    OBJ_CODE_COMMAND_WRONG_FORMAT = 70001,
    OBJ_CODE_COMMAND_NOT_FOUND = 70002
};
