...
/* close database */
obj_status_t obj_v1_engine_close_db(obj_engine_t *engine, obj_stringdata_t *db) {
    obj_v1_engine_t *v1_engine = (obj_v1_engine_t *)engine;

}

/* drop database */
obj_status_t obj_v1_engine_drop_db(obj_engine_t *engine, obj_stringdata_t *db) {
    obj_v1_engine_t *v1_engine = (obj_v1_engine_t *)engine;
    /* delete from map */
...
obj_db_catalog_entry_t *obj_v1_engine_get_db_catalog_entry(obj_engine_t *engine, obj_stringdata_t *db) {
    obj_v1_engine_t *v1_engine = (obj_v1_engine_t *)engine;
...
obj_db_catalog_entry_t *obj_v1_engine_get_or_create_db_catalog_entry(obj_engine_t *engine, obj_stringdata_t *db, obj_bool_t *create) {
    obj_v1_engine_t *v1_engine = (obj_v1_engine_t *)engine;
    obj_prealloc_map_entry_t *entry = obj_prealloc_map_find(&v1_engine->map, db);
